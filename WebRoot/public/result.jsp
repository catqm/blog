...
<!--
	...
	-->
<link rel="stylesheet" type="text/css" href="/blog/css/result.css">
...
<body>
	...
	<div class="result">
		...
		<div class="article_title">
			<%
				List<ArticleInfo> artiList = (List<ArticleInfo>) request.getAttribute("article");
			...
			<div class="each">
				...
				<ul class="info">
					<li>作者：<a
						href="/blog/user/home.jsp?username='article.getUsername()'"><%=article.getUsername()%></a>&nbsp;&nbsp;|
					</li>
					<li>&nbsp;&nbsp;<%=article.getTime()%> &nbsp;&nbsp;|
					</li>
